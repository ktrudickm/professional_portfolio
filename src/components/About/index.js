    ...
    <div className='container about-page'>
      <div className='text-zone'>
        ...
        <p>
          ...
          Currently, I am seeking roles where I can contribute to meaningful and challenging projects and ultimately 
          learn new technologies, utilize and strengthen my current skillsets, and collaborate alongisde inspiring and driven individuals.
        </p>
        <p>
